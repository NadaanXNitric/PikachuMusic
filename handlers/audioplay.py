...
async def stream(_, message: Message):
            ...
            [
                [
                    InlineKeyboardButton(
                        text="👥 ɢʀᴏᴜᴘ",
                        url=f"https://t.me/Sanki_BOTs_Support"),
                    InlineKeyboardButton(
                        text="ᴄʜᴀɴɴᴇʟ 📣​",
    ...
    if audio:
        ...
        return await lel.edit_text("❗Pɪᴋᴀ Pɪᴋᴀ, ʏᴏᴜ ᴅɪᴅ ɴᴏᴛ ɢɪᴠᴇ ᴍᴇ ᴀᴜᴅɪᴏ ғɪʟᴇ ᴏʀ ʏᴛ ʟɪɴᴋ ᴛᴏ sᴛʀᴇᴀᴍ!")
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        caption=f"🎧 Pɪᴋᴀ Pɪᴋᴀ, Tʀᴀᴄᴋ ᴀᴅᴅᴇᴅ ᴛᴏ ᴛʜᴇ **queue**\n\n🔢 Pᴏsɪᴛɪᴏɴ: » `{position}` «\n🎧 Rᴇǫᴜᴇsᴛ Bʏ » {costumer}\n\n⚡ __Pᴏᴡᴇʀᴇᴅ Bʏ 「ᴘɪᴋᴀᴄʜᴜχᴅ」__")
        ...
        photo=f"{AUD_IMG}",
        reply_markup=keyboard,
        caption=f"🎧 Pɪᴋᴀ Pɪᴋᴀ, **Sᴛᴀᴛᴜs** » `ᴘʟᴀʏɪɴɢ`\n🎧 Rᴇǫᴜᴇsᴛ Bʏ » {costumer}\n\n⚡ __Pᴏᴡᴇʀᴇᴅ Bʏ 「ᴘɪᴋᴀᴄʜᴜχᴅ」__"
        )
        return await lel.delete()
